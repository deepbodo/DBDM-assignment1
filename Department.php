...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <input  class="form-input" type="text" name="building" id="building" required><br><br>

        <label for="budget">Budget:</label>
        <input class="form-input" type="number" name="budget" id="budget" required><br><br>
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "INSERT INTO departments (`deptname`, `building`, `budget`) VALUES ('$deptname', '$building', '$budget')";
