...
$query = "SELECT * FROM instructors ,teaches WHERE instructors.instructorId=teaches.ID";
...
<html>
<head>
    <title>Instructors and Teaches Natural Join Data</title>
    <style>
        /* Style the table */
        .styled-table {
...
<body>
    <h1>Instructors and Teaches Data</h1>
