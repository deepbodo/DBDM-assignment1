...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <input class="form-input" type="text" name="advisorName" id="advisorName" required><br><br>

        <label for="email">Email:</label>
        <input  class="form-input" type="email" name="email" id="email" required><br><br>
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "INSERT INTO advisors ( `advisorName`,`email`, `deptname`) VALUES ('$advisorName','$email', '$deptName')";
